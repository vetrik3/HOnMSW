...
namespace Client
{
    public class FilePiece_UDP
    {
        ...
        public static int data_size = 65000;
        ...
        */
        ...
        public FilePiece_UDP(Int16 st, Int64 num, byte[] file_data)
        {
            data = file_data;
            number = num;
            state = st;
        ...
        public static byte[] get_missing_packet(Int64 missing_number)
        {
            ...
            FilePiece_UDP piece = new FilePiece_UDP(-1, -1, number_data);

            return piece.get_packet();
        }

        static public FilePiece_UDP parse_packet(byte[] packet)
        {
            ...
            FilePiece_UDP piece = new FilePiece_UDP(status, piece_number, data);
